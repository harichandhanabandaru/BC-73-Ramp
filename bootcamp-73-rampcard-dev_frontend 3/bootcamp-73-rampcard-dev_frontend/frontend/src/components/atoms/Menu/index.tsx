  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem value={options[2].value}   style={{ cursor: 'default' }}   disableRipple>
          <Typography
            variant="body2"
        ...
        <MenuItem value={options[3].value}   style={{ cursor: 'default' }}  disableRipple>
          <Typography
            variant="body2"
        ...
        <MenuItem value={options[4].value}    style={{ cursor: 'default' }}  disableRipple>
        ...
        <MenuItem value={options[5].value}   data-testid="logout" onClick={handleLogOut} disableRipple>
          <ListItemIcon style={{ minWidth: "23px" }}>
