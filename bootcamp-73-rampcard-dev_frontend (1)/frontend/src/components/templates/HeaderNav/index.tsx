...
import CreateRampCategoryCard from "../../organisms/CreateRampCategoryCard";
  ...
  return (
    <>
      ...
      {value === 6 && selectedItem === 0 && (
        <ReimbursementDraftPage handleOpenNewBill={handleOpenNewBill} />
      )}
      ...
      {openNewBill && (
        <NewBill open={openNewBill} onClose={handleCloseNewBill} />
      )}
    </>
  );
};
