...
describe("TypographyTextfieldIcon", () => {
  ...
  it("renders the text correctly", () => {
    render(<TypographyTextfieldIcon heading={"Test Value"} text={"Test Value"} onRemove={remove} {...props} />);
    const text = screen.getByText("Test Value");
    expect(text).toBeInTheDocument();
  });

  it("renders the placeholder correctly", () => {
    render(<TypographyTextfieldIcon heading={""} text={""} onRemove={remove} {...props} />);
